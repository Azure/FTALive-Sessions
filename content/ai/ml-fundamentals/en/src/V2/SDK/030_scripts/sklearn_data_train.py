#ref: https://github.com/Azure/azureml-examples/blob/main/sdk/jobs/single-step/scikit-learn/diabetes/src/main.py
...
def parse_args():
    ...
    parser.add_argument("--diabetes-asset", type=str)
    parser.add_argument("--diabetes-mltable", type=str)
