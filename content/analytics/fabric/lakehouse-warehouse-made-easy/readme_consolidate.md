...
(Image from [here](https://learn.microsoft.com/en-us/fabric/get-started/microsoft-fabric-overview)))
</br>
...
As we moved from IaaS to PaaS that was an industry sigh of relief that we didn't need to install products anymore, nor login to a VM. All the "boring" stuff was taken care of by our cloud provider. Phew. </br>
...
### **Demo** : Let's explore how we can access the Fabric today.
...
--------------------------------------------------------------------
--------------------------------------------------------------------
## Challenge: How often do we duplicate data and store it in various formats within a data analytics solution?
