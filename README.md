...
Additionally if you visit https://aka.ms/ftalive you will see a github  link for each session that maps directly the folder structure here.
...
Q&A	| Question and Answer | Got questions about Azure? Need specific guidance on your project implementation? In this session we flip the microphone so you drive the conversation where our panel of expert FastTrack for Azure engineers will  answer your queries, help you along in your Azure journey and try our best to provide support where you need it. Note that this is a multi-customer hour so please be conscious of other people on the line!
  |  |  |  |
Security	| Azure Security Center & Defender | This is a fundamentals session into Azure Security intended for beginners or users looking for a refresher in the essential guidelines in setting up your Azure Security design. We will cover Security Center, Azure Defender capabilities, guidance and tips to improve your Secure Score.
  |  |  |  |
